...
<div class="container" style="margin-top: 150px;">
    <div class="text-center">
        <img src="{{ asset('images/erreur500.png') }}" alt="erreur 500" class="img-responsive" style="margin-left: auto; margin-right: auto">
        <p>Erreur 500. Toutes mes excuses, veuillez me contacter : </p><a href="mailto:aymericboi@gmail.com">aymericboi@gmail.com</a>
    </div>
</div>
